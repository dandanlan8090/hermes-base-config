...
description: "新增技能开发规范 (Skill Development Guidelines) — 触发：创建新技能/修改现有技能。禁用：纯文档修改、配置调整。"
version: 2.0.0
author: Hermes Agent
license: MIT
...
description: "中文描述 —— 触发场景。禁用：排除场景。"  # 必填
...
touch ~/.hermes/skills/<category>/<skill-name>/SKILL.md
```
